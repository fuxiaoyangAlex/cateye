...
/**
 * REST controller for managing {@link com.aiyun.project2.domain.Actor}.
 */
@RestController
@RequestMapping("/api")
public class ActorResource {
     ...
     */
    @GetMapping("/actors")
    public ResponseEntity<List<Actor>> getAllActors(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
