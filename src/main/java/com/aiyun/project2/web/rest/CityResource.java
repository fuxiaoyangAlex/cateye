...
/**
 * REST controller for managing {@link com.aiyun.project2.domain.City}.
 */
@RestController
@RequestMapping("/api")
public class CityResource {
     ...
     */
    @GetMapping("/cities")
    public ResponseEntity<List<City>> getAllCities(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
