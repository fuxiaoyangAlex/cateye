...
import com.aiyun.project2.repository.CityRepository;
import com.aiyun.project2.service.CityService;
...
public class CityResourceIT {
    ...
    public void createCity() throws Exception {
        ...
        assertThat(testCity.getParentId()).isEqualTo(DEFAULT_PARENT_ID);
        assertThat(testCity.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testCity.getRank()).isEqualTo(DEFAULT_RANK);
    }
    ...
    public void updateCity() throws Exception {
        ...
        City testCity = cityList.get(cityList.size() - 1);
        assertThat(testCity.getParentId()).isEqualTo(UPDATED_PARENT_ID);
        assertThat(testCity.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testCity.getRank()).isEqualTo(UPDATED_RANK);
    }
