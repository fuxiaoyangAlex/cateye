...
import { CinemaComponent } from 'app/entities/cinema/cinema.component';
import { CinemaService } from 'app/entities/cinema/cinema.service';
import { Cinema } from 'app/shared/model/cinema.model';

describe('Component Tests', () => {
  describe('Cinema Management Component', () => {
    let comp: CinemaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CinemaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cinemas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
