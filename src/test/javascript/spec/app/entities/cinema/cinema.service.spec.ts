...
describe('Service Tests', () => {
  describe('Cinema Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(CinemaService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Cinema(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Cinema', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
