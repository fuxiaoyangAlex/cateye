...
import { VarietyComponent } from 'app/entities/variety/variety.component';
import { VarietyService } from 'app/entities/variety/variety.service';
import { Variety } from 'app/shared/model/variety.model';

describe('Component Tests', () => {
  describe('Variety Management Component', () => {
    let comp: VarietyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VarietyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.varieties[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
