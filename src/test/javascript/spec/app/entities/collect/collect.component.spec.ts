...
import { CollectComponent } from 'app/entities/collect/collect.component';
  ...
  describe('Collect Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CollectComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.collects[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
